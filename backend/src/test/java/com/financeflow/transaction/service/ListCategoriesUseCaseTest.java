...
class ListCategoriesUseCaseTest {
    ...
    void shouldListCategoriesSuccessfully() {
        ...
        CategoryEntity entity1 = new CategoryEntity(catId1, null, "Default Income", null, Instant.now(), Instant.now());
        CategoryEntity entity2 = new CategoryEntity(catId2, userId, "Custom Expense", null, Instant.now(), Instant.now());
