...
class ListAccountsUseCaseTest {
    ...
    void shouldReturnAccountListWhenUserHasAccounts() {
        ...
        AccountEntity account2 = new AccountEntity(
            ...
            new BigDecimal("-50.00"), new BigDecimal("1000.00"), 5, 10, null, AccountStatus.ACTIVE, Instant.now(), Instant.now()
        );
        ...
        assertThat(result.get(0).status()).isEqualTo(AccountStatus.ACTIVE);
